...
class vit_attentiona(nn.Module):
    def __init__(self, input_isze, norm_layer=nn.LayerNorm):
        super(vit_attentiona, self).__init__()

        self.input_size = input_isze

        # encoder
        self.rgb_vit_iterate = mobile_vit_small()
        self.depth_vit_iterate = mobile_vit_small()
        ...
        self.fusion_41 = fusion_scale_ca(288 // 2, 160)
        self.fusion_42 = fusion_scale_sa(288 // 2, 160)
        self.fusion_4 = fusion_modal(160, 128)

        self.fusion_31 = fusion_scale_ca(128, 128)
        self.fusion_32 = fusion_scale_sa(128, 128)
        self.fusion_3 = fusion_modal(128, 96)

        self.fusion_21 = fusion_scale_ca(96, 96)
        self.fusion_22 = fusion_scale_sa(96, 96)
        self.fusion_2 = fusion_modal(96, 64)

        self.fusion_11 = fusion_scale_ca(64, 64)
        self.fusion_12 = fusion_scale_sa(64, 64)
        self.fusion_1 = fusion_modal(64, 32)

        self.abg = auxiliary_body_generate(576, 32, self.decoder)
        self.aeg = auxiliary_edge_generate(320, 32, self.decoder)

        self.conv1 = BConv(64, 32)
        self.conv2 = BConv(96, 32)
        self.conv3 = BConv(128, 32)
